...
public class Program
{
	...
	private void check()
	{
		...
		fileSystem.loadPaths();
		
		File programDir = fileSystem.getPath(FileSystem.PATH.SAVE_DEFAULT_DIR);
		...
		else
		{
			...
			String defaultSave =  fileSystem.getPath(FileSystem.PATH.SAVE_DEFAULT_DIR).getAbsolutePath();
			...
			try
			{
				Files.createDirectories(Paths.get(programDir.getAbsolutePath()));
			}
			catch (IOException e)
			{
				e.printStackTrace();
